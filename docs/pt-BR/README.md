...
| `CCDB_LOG_FILE` | Caminho para um arquivo de log. Quando definido, um handler de arquivo rotativo (10 MB por arquivo, 5 backups) é adicionado ao handler stdout padrão. Útil para monitoramento e alertas | (opcional) |
