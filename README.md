...
If you prefer fine-grained control, set `CLAUDE_ALLOWED_TOOLS` to a comma-separated list of tool names (e.g. `Bash,Read,Write`). Tools not in the list will be rejected by Claude CLI.
