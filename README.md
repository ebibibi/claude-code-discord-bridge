...
| `CCDB_CODEX_STATUS_ACCOUNT` | Set to `1` to include the active ChatGPT account name or email in the Codex usage footer. Disabled by default to avoid exposing account details in shared Discord channels. | `0` |
