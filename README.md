...
| `CCDB_LOG_FILE` | Path to a log file. When set, a rotating file handler (10 MB per file, 5 backups) is added alongside the default stdout handler. Useful for monitoring and alerting. | (optional) |
